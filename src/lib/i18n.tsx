...
export const dictionaries: Record<Locale, Dictionary> = {
  nl: {
    ...
    home: {
      ...
      title: "Bouw je kampioensteam en pak die schaal!",
    ...
    teamSelector: {
      ...
      title: "Draft richting de titel.",
      description: "Kies een mode, zet je formatie vast en vul je XI positie voor positie. Elke roll geeft je een historisch team voor de actieve plek op het veld.",
    ...
    season: {
      run: "Seizoensrun",
      title: "Kan deze XI kampioen worden?",
      description: "De engine draait volledig client-side met momentum en een beetje Eredivisie-onzin.",
      challenge: (formation) => `Draft klaar? Simuleer je ${formation} en kijk of deze XI de titel kan pakken.`,
  ...
  en: {
    ...
    home: {
      eyebrow: "Eredivisie Champ",
      title: "Build a title-winning XI from historic Eredivisie greatness.",
      ...
      start: "Start game",
      subtitle: "Can you win the title?",
    ...
    teamSelector: {
      ...
      title: "Draft your way to the title.",
      description: "Choose a mode, lock your formation, and fill your XI one slot at a time. Every roll gives you a historic team for the active position on the pitch.",
    ...
    season: {
      run: "Season run",
      title: "Can this XI win the title?",
      description: "The engine runs fully client-side with momentum and a little Eredivisie nonsense.",
      challenge: (formation) => `Draft complete? Simulate your ${formation} and see if this XI can bring home the title.`,
